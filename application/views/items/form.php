...
<fieldset id="item_basic_info">
	...
	<div class="form-group form-group-sm">
		...
		<?php echo form_label($this->lang->line('items_warranty'), 'warranty', array('class' => 'control-label col-xs-3')); ?>
		<div class='col-xs-8'>
			<?php echo form_input(
				array(
					'name' => 'warranty',
	...
	<!-- Imal Wholesale Price -->
	<div class="form-group form-group-sm">
		<?php echo form_label($this->lang->line('item_wholesale_selling'), 'wholesale_selling_price', array('class' => 'control-label col-xs-3')); ?>
		<div class="col-xs-4">
			<div class="input-group input-group-sm">
				<?php if (!currency_side()) : ?>
					<span class="input-group-addon input-sm"><b><?php echo $this->config->item('currency_symbol'); ?></b></span>
				...
				<?php echo form_input(
					array(
						...
						'class' => 'form-control input-sm',
						'onClick' => 'this.select();',
						'value' => to_currency_no_money($item_info->wholesale_selling_price)
					)
				); ?>
				<?php if (currency_side()) : ?>
					<span class="input-group-addon input-sm"><b><?php echo $this->config->item('currency_symbol'); ?></b></span>
