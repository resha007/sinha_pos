  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav sidebar sidebar-light accordion" id="accordionSidebar">
      ...
      <?php
        ...
        ?>
          <li class="nav-item">
            <a class="nav-link" target="mainFrame" href="<?php echo site_url("$module->module_id");?>">
              <!-- <i class="fas fa-fw fa-chart-area"></i> -->
              <img src="<?php echo base_url().'images/menubar/'.$module->module_id.'.png';?>" border="0" alt="Menubar Image" width="30px" title="<?php echo $this->lang->line("module_".$module->module_id) ?>"/>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      <div id="content">
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              ...
              <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                ...
                <a class="dropdown-item" href="<?php echo('home/change_password/'.$user_info->person_id)?>">
        ...
        <!-- Container Fluid-->
        <iframe name="mainFrame" src="<?php echo site_url("dashboard");?>" height="80%" width="100%" frameBorder="0"></iframe>

          <!-- change password-->
          <div class="modal fade" id="passwordModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabelLogout"
            aria-hidden="true">
