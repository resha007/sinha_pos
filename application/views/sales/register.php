	...
	<table class="sales_table_100" id="register">
		<thead>
			<tr>
				...
				<th style="width: 10%;"><?php echo $this->lang->line('sales_warranty'); ?></th>
					...
					<tr>
						...
						<td>
							...
							if ($items_module_allowed) {
								echo form_input(array('name' => 'warranty', 'class' => 'form-control input-sm', 'value' => ($item['warranty']), 'tabindex' => ++$tabindex, 'onClick' => 'this.select();'));
							} else {
								echo to_currency($item['warranty']);
								echo form_hidden('warranty', ($item['warranty']));
							}
