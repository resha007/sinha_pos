	...
	<table id="items">
		...
		foreach($cart as $line=>$item)
		{
			...
			?>
				<tr class="item-row">
					...
					<?php endif; ?>
					<td style='text-align:left;' class="item-name"><?php echo ($item['is_serialized'] || $item['allow_alt_description']) && !empty($item['description']) ? $item['description'] : $item['name'] . ' ' . $item['attribute_values']; ?></td>
		...
		?>
			<tr>
				...
				<td colspan="1" class="total-line"><?php echo (float)$tax['tax_rate'] . '% ' . $tax['tax_group']; ?></td>
		...
		?>
			<tr>
				<td colspan="<?php echo $invoice_columns-2; ?>" class="blank"> </td>
				<td colspan="1" class="total-line"><?php echo $splitpayment[0]; ?></td>
		...
		?>
			<tr>
				<td colspan="<?php echo $invoice_columns-2; ?>" class="blank"> </td>
				<td colspan="1" class="total-line"><?php echo $this->lang->line('sales_giftcard_balance'); ?></td>
		...
		<tr>
			<td colspan="<?php echo $invoice_columns-2; ?>" class="blank"> </td>
			<td colspan="1" class="total-line"><?php echo $this->lang->line($amount_change >= 0 ? ($only_sale_check ? 'sales_check_balance' : 'sales_change_due') : 'sales_amount_due') ; ?></td>
