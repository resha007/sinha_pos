...
<div class="print_hide" id="control_buttons" style="text-align:right">
	<a href="javascript:printdoc();" onclick="document.title='<?php echo $this->config->item('company').'-Sales Receipt #'. $sale_id; ?>';"><div class="btn btn-info btn-sm", id="show_print_button"><?php echo '<span class="glyphicon glyphicon-print">&nbsp</span>' . $this->lang->line('common_print'); ?></div></a>
	<?php if(!empty($customer_email)): ?>
