...
class Summary_taxes_copy extends Summary_report
{
	...
	public function getData(array $inputs)
	{
		...
		$query = $this->db->query(
			"SELECT percent, COUNT(DISTINCT sale_id) AS count, ROUND(SUM(subtotal), $decimals) AS subtotal, ROUND(SUM(tax), $decimals) AS tax, ROUND(SUM(total), $decimals) AS total
			FROM (
				SELECT
