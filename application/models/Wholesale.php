 ...
 * Sale class
 */
class Wholesale extends CI_Model
{
	/**
	 * Get sale info
	 */
	...
	public function get_payment_options($giftcard = TRUE, $reward_points = FALSE)
	{
		...
		$payments[$this->lang->line('sales_bank')] = $this->lang->line('sales_bank');
		...
		if ($this->whole_sale_lib->get_mode() == 'sale_work_order') {
