...
function get_sales_manage_table_headers()
{
	...
	$headers[] = array('shipping' => '&nbsp', 'sortable' => FALSE);
...
function get_sale_data_row($sale)
{
	...
	$row['shipping'] = anchor($controller_name."/shippingLabel/$sale->sale_id", '<span class="glyphicon glyphicon-plane"></span>',
		array('title' => "Show shipping label")
	);
...
function get_items_manage_table_headers()
{
	...
	$headers = array(
		...
		array('wholesale_selling_price' => $CI->lang->line('item_wholesale_selling')),
		array('quantity' => $CI->lang->line('items_quantity')),
		array('warranty' => $CI->lang->line('items_warranty'))
	);
...
function get_item_data_row($item)
{
	...
	$columns = array(
		...
		'wholesale_selling_price' => to_currency($item->wholesale_selling_price),
